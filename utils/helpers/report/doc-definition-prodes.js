...
module.exports = function (headerDocument, reportData, title) {
  return {
    ...
    content: [
      ...
      {
        text: (
          reportData.property.prodesArea + ' hectares no imóvel rural denominado ' + reportData.property.name +
          ' no período de ' + reportData.formattedFilterDate + ', conforme desmatamento explicitado ' +
